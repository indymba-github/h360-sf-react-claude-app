    ...
    <div className="flex flex-1 items-center justify-center p-8">
      <div className="max-w-sm w-full text-center">
        ...
        {isSessionExpired ? (
          ...
          <>
            <h2 className="text-base font-semibold text-gray-900 mb-1">Failed to load account</h2>
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <a
                href="/accounts"
                className="inline-flex items-center justify-center px-4 py-2 rounded-lg border border-gray-200 text-gray-700 text-sm font-medium hover:bg-gray-50 transition-colors"
              >
                Back to accounts
              </a>
            </div>
